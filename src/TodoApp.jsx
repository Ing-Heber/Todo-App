import {TodoForm, TodoEmpty, TodoList, Dropdown} from "./components/index";
import {useTodos} from "./hooks/useTodos";
import 'animate.css'
import {useState, useMemo} from "react";
import {showTypes} from "./types";
import {DropdownItems} from "./constants";
import {getFilteredTodosByStatus} from "./utils/getTodos.js";
        ...
        <div className="animate__animated animate__fadeIn">
            <div className="main__header">
                <div className="container">
                    <h1 className='text-center'><span className='color-blue'>To</span><span
                        className='color-purple'>do</span></h1>
